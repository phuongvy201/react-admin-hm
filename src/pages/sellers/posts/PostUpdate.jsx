...
export default function PostUpdate() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setTopicId(response.data.data.topic_id);
  ...
  const handleSubmit = (e) => {
    ...
    if (!cropData) {
      Toast.fire({
        icon: "error",
        title: "Please crop the photo before saving!",
      });
      return; // Dừng lại nếu không có cropData
    }

    const postData = new FormData();
    const mainImageFile = dataURLtoFile(cropData, "main-post-image.png");
    postData.append("title", name);
    postData.append("description", description);
    postData.append("detail", detail);
    postData.append("topic_id", topic_id);
    postData.append("status", status);
    postData.append("image", mainImageFile ? mainImageFile : image);
    postData.append("created_by", 1);
            ...
            <div className="col-md-6">
              <div className="card card-primary">
                <div className="card-body">
                  ...
                  <div className="form-group">
                    <label htmlFor="inputDescription">Post Description</label>
                    <textarea
                      id="inputDescription"
                      className="form-control"
                      rows={4}
                  ...
                  <div className="form-group">
                    <label htmlFor="inputDescription">Post Detail</label>
                    <CKEditor
