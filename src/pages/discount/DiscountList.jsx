...
export default function DiscountList() {
  ...
  const fetchDiscounts = async (page = 1) => {
    try {
      setLoading(true);
      const response = await discountService.getAllDiscounts(page);
                    ...
                    <table className="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th style={{ width: 250 }}>Seller Name</th>
                        ...
                        {discounts.map((discount) => (
                          <tr key={discount.id}>
                            ...
                            <td>
                              ...
                              <div>
                                <Link
                                  ...
                                  className="text-decoration-none text-info mb-2"
                                >
                            ...
                            <td>
                              <Link
                                className="text-info"
                                to={`/admin/updateSeller/${discount.seller_id}`}
                              >
                                {discount.seller_name}
                              </Link>
                            </td>
                            ...
                            <td>
                              ...
                              <button
                                ...
                                onClick={() => handleUpdateStatus(discount.id)}
                                title={
                                  discount.status === 1
